<?php
/**
 * @purpose  Temporary override to get page to load. Fix is in core. Remove soon!
 */
...
$params->set('show_rating', $this->config->get('show_rating'));
...
if ($this->config->get('supportedtag') && isset($this->supportedtag))
{
	if (in_array($this->line->id, $this->supportedtag))
	{
		$cls .= ' supported';
	}
}
